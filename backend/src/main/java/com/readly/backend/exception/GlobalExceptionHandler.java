 ...
 * (controllers/services) and converts them into a consistent JSON error body
 * with the right HTTP status code, instead of a raw stack trace / HTML page.
 * ============================================================================
 * This is what @RestControllerAdvice is for: it's like a try/catch that
 * wraps every single controller method automatically.
 * ============================================================================
 */
...
public class GlobalExceptionHandler {
    ...
    // Triggered automatically whenever a @Valid-annotated request DTO fails validation.
